...
{
    texto = new wictor::Converter();
    ui->setupUi(this);
    ui->CoverterMaiusculo->setDisabled(1);
    ui->CoverterMinusculo->setDisabled(1);
    ui->CoverterMinusculoMaiusculo->setDisabled(1);
}
...
void MainWindow::on_OpenArchive_clicked()
{
    try {
        ...
        ui->CoverterMaiusculo->setDisabled(0);
        ui->CoverterMinusculo->setDisabled(0);
        ui->CoverterMinusculoMaiusculo->setDisabled(0);
